...
public class School {
	...
	public String getValuesString() {
		String values ="'"+ this.id + "','" + this.name + "','" + this.board + "','" + this.startedDate.toString() + "','" + this.joinedDate.toString()
				+ "','" + this.website + "'," + this.primaryContact + "," + this.secondaryContact + ",'" + this.primaryEmail
				+ "','" + this.secondaryEmail + "','" + this.languages + "'," + this.kinderGardenAvailable + ","
				+ this.primaryAvailable + "," + this.secondaryAvailable + "," + this.higherSecondaryAvailable + ","
				+ this.governmentAided + "," + this.international + "," + this.smartSchool + ",'" + this.description
				+ "','" + this.logo + "','" + this.image1 + "','" + this.image2 + "','" + this.image3 + "','" + this.doorNo + "','"
				+ this.street + "','" + this.area + "','" + this.city + "'," + this.pincode + ",'" + this.createdBy + "','"
				+ this.updatedBy + "','" + this.createdDateTime + "','" + this.updatedDateTime + "'";
		return values;
	}
}
